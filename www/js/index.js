$(document).ready(function(){
  ...
  $("#select-element").click(function(){
    ...
    $.getJSON(globalPath   + elementNumber + '.json', function(jsonObj) {
      ...
      $("#tips-table").replaceWith("\
        <table id=\"tips-table\">\
          <tr>\
            <td><button id=\"toggle-tip-1\" class=\"w3-btn w3-blue\">01</button></td>\
            <td id=\"tip-1\" class=\"invisible\">" + jsonObj.tips[0] + "</td>\
          </tr>\
          <tr>\
            <td><button id=\"toggle-tip-2\" class=\"w3-btn w3-blue\">02</button></td>\
            <td id=\"tip-2\" class=\"invisible\">" + jsonObj.tips[1] + "</td>\
          </tr>\
          <tr>\
            <td><button id=\"toggle-tip-3\" class=\"w3-btn w3-blue\">03</button></td>\
            <td id=\"tip-3\" class=\"invisible\">" + jsonObj.tips[2] + "</td>\
          </tr>\
          <tr>\
            <td><button id=\"toggle-tip-4\" class=\"w3-btn w3-blue\">04</button></td>\
            <td id=\"tip-4\" class=\"invisible\">" + jsonObj.tips[3] + "</td>\
          </tr>\
          <tr>\
            <td><button id=\"toggle-tip-5\" class=\"w3-btn w3-blue\">05</button></td>\
            <td id=\"tip-5\" class=\"invisible\">" + jsonObj.tips[4] + "</td>\
          </tr>\
          <tr>\
            <td><button id=\"toggle-tip-6\" class=\"w3-btn w3-blue\">06</button></td>\
            <td id=\"tip-6\" class=\"invisible\">" + jsonObj.tips[5] + "</td>\
          </tr>\
          <tr>\
            <td><button id=\"toggle-tip-7\" class=\"w3-btn w3-blue\">07</button></td>\
            <td id=\"tip-7\" class=\"invisible\">" + jsonObj.tips[6] + "</td>\
          </tr>\
          <tr>\
            <td><button id=\"toggle-tip-8\" class=\"w3-btn w3-blue\">08</button></td>\
            <td id=\"tip-8\" class=\"invisible\">" + jsonObj.tips[7] + "</td>\
          </tr>\
          <tr>\
            <td><button id=\"toggle-tip-9\" class=\"w3-btn w3-blue\">09</button></td>\
            <td id=\"tip-9\" class=\"invisible\">" + jsonObj.tips[8] + "</td>\
          </tr>\
          <tr>\
            <td><button id=\"toggle-tip-10\" class=\"w3-btn w3-blue\">10</button></td>\
  ...
  $(document).on('click', '#toggle-tip-1', function(){
    ...
    $("#toggle-tip-1").addClass("w3-indigo");
  ...
  $(document).on('click', '#toggle-tip-2', function(){
    //Mark the tips that have already been shown
    $("#toggle-tip-2").addClass("w3-indigo");
  ...
  $(document).on('click', '#toggle-tip-3', function(){
    //Mark the tips that have already been shown
    $("#toggle-tip-3").addClass("w3-indigo");
  ...
  $(document).on('click', '#toggle-tip-4', function(){
    //Mark the tips that have already been shown
    $("#toggle-tip-4").addClass("w3-indigo");
  ...
  $(document).on('click', '#toggle-tip-5', function(){
    //Mark the tips that have already been shown
    $("#toggle-tip-5").addClass("w3-indigo");
  ...
  $(document).on('click', '#toggle-tip-6', function(){
    //Mark the tips that have already been shown
    $("#toggle-tip-6").addClass("w3-indigo");
  ...
  $(document).on('click', '#toggle-tip-7', function(){
    //Mark the tips that have already been shown
    $("#toggle-tip-7").addClass("w3-indigo");
  ...
  $(document).on('click', '#toggle-tip-8', function(){
    //Mark the tips that have already been shown
    $("#toggle-tip-8").addClass("w3-indigo");
  ...
  $(document).on('click', '#toggle-tip-9', function(){
    //Mark the tips that have already been shown
    $("#toggle-tip-9").addClass("w3-indigo");
  ...
  $(document).on('click', '#toggle-tip-10', function(){
    //Mark the tips that have already been shown
    $("#toggle-tip-10").addClass("w3-indigo");
